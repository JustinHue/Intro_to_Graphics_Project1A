"""
    ...
    Version: 
        0.5 -> Added life counter (start with three lives)
            -> Goomba now stops and goes for AI.
            -> Added score counter
            -> Added start screen with instructions, click anykey to continue
            -> Added end screen with score, click anykey to play again
            -> Added start screen music theme
            -> Fixed escape to now exit program
            -> Fixed issue where ritz could jump right off the bat since his dy speed is 0, trigger falling = False
            -> Added loop for scenes to make the scenes flow
            -> Map gets reset when Ritz falls below map
            
            **** Idea to fix collision. Only check for collision needed. (TOP, LEFT, BOTTOM, RIGHT)
                 Collision information of tiles stored in data file.
"""
